...
<figure>
  ...
  <figcaption markdown="span">The two green windows represent the same upright orientation, at $$-\pi$$ and $$\pi$$. The legend distinguishes trajectories that do not reach the window from those that enter it too quickly.</figcaption>
</figure>
